...
export const App = () => {
  ...
  return (
    <div className='base-layout'>
      <nav className='nav'>
        <div><img src='/images/profile-pic.png' className='profile-pic' /></div>
        <div><Link to='/'>About Me</Link></div>
        <div><Link to='/projects-and-work'>Work & Projects</Link></div>
      ...
      {isMobile && (
        <nav className='mobile-nav'>
          ...
          <div className='mobile-nav__links' style={{width: mobNavToggled ? 320 : 0}}>
